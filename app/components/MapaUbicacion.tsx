...
export default function MapaUbicacion() {
  ...
  useEffect(() => {
    ...
    import("maplibre-gl").then((ml) => {
      ...
      // Detecta cambios de tamaño del contenedor (ej: accordion animándose)
      // y fuerza a MapLibre a recalcular el canvas GL
      ...
      map.on("load", () => {
        ...
        intervalRef.current = setInterval(() => {
          ...
          // Mover viajero DOM — mismo sistema de coordenadas que destino
          ...
          if (step >= ROUTE_STEPS) {
            ...
            timeoutRef.current = setTimeout(() => {
              ...
              // Eliminar viajero — queda solo el marcador destino
